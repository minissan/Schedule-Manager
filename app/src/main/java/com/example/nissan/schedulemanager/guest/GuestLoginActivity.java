  ...
  /*  @Override
   ...
   /* private void signUp() {
    ...
    private boolean validateForm() {
        boolean result = true;
        if (!mEmailField.getText().toString().contains("guest@sm.com")){
    ...
    */
    ...
    public void AlertBox(){
        //Alert Box
        AlertDialog.Builder builder = new AlertDialog.Builder(GuestLoginActivity.this, R.style.AlertDialogStyle);
