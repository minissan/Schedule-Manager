...
public class AdminDashBoard extends BaseActivity {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_settings) {
            ...
            startActivity(new Intent(AdminDashBoard.this, ExpertLoginActivity.class));
        }
    ...
    public void onStart() {
        ...
        mAuth.addAuthStateListener(mAuthListener);
            FirebaseRecyclerAdapter<ExpertList, ExpertViewHolder> firebaseRecyclerAdapter = new FirebaseRecyclerAdapter<ExpertList, ExpertViewHolder>(
                    ...
                    AdminDashBoard.ExpertViewHolder.class,
                    mDatabase
            ) {
                @Override
                protected void populateViewHolder(ExpertViewHolder viewHolder, ExpertList model, int position) {
                    ...
                    viewHolder.mView.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View view) {
                            ...
                            Intent singleExpertIntent = new Intent(AdminDashBoard.this, AdminSingleExpert.class);
