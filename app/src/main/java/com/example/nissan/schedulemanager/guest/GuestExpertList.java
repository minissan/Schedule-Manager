...
public class GuestExpertList extends BaseActivity {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_settings) {
            ...
            startActivity(new Intent(GuestExpertList.this, ExpertLoginActivity.class));
        }
    ...
    public void onStart() {
        ...
        FirebaseRecyclerAdapter<ExpertList, GuestExpertList.ExpertViewHolder> firebaseRecyclerAdapter = new FirebaseRecyclerAdapter<ExpertList, GuestExpertList.ExpertViewHolder>(

                ExpertList.class,
                R.layout.expert_row_guest,
                GuestExpertList.ExpertViewHolder.class,
                mDatabase
        ) {
            @Override
            protected void populateViewHolder(GuestExpertList.ExpertViewHolder viewHolder, ExpertList model, int position) {
                ...
                viewHolder.mView.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        Intent singleExpertIntent = new Intent(GuestExpertList.this, GuestDashBoard.class);
